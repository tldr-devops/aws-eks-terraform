# variable "vector_role" {
#   description = "Role for this Vector instance, valid options are: Agent, Aggregator, and Stateless-Aggregator"
#   type        = string
#   default     = "Agent"
# }
# 
# variable "vector_sources" {
#   description = "Vector sources: https://vector.dev/docs/reference/configuration/sources/"
#   type        = string
#   default     = null
# }
# 
# variable "vector_transforms" {
#   description = "Vector transforms: https://vector.dev/docs/reference/configuration/transforms/"
#   type        = string
#   default     = null
# }
# 
# variable "vector_sinks" {
#   description = "Vector sinks: https://vector.dev/docs/reference/configuration/sinks/"
#   type        = string
#   default     = null
# }
