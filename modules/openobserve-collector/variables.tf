variable "zo_endpoint" {
  description = "OpenObserve url like 'https://api.openobserve.ai/api/default/'"
  type        = string
}

variable "zo_authorization" {
  description = "OpenObserve Authorization Header like 'Basic < base64 encoded auth >'"
  type        = string
}
